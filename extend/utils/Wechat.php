...
class Wechat
{
    ...
    public function createWechatPay(): Wechat
    {
        ...
        $merchantPrivateKeyFilePath = 'file://'.app()->getRootPath().'/extend/utils/cert/apiclient_key.pem';
        $merchantPrivateKeyInstance = Rsa::from($merchantPrivateKeyFilePath, Rsa::KEY_TYPE_PRIVATE);

        // 「商户API证书」的「证书序列号」
        $merchantCertificateSerial = PemUtil::parseCertificateSerialNo($merchantPrivateKeyFilePath);
