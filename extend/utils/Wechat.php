...
class Wechat
{
    ...
    public function createWechatPay(): Wechat
    {
        ...
        $merchantPrivateKeyFile = file_get_contents(app()->getRootPath().'extend/utils/cert/apiclient_cert.pem');
        ...
        $platformCertificateFilePath = file_get_contents(app()->getRootPath().'extend/utils/cert/apiclient_cert.pem');
